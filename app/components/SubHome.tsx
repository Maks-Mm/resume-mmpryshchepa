          ...
          <div className="w3-twothird w3-margin-top" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
            ...
            <div className={`w3-container w3-card w3-white w3-margin-bottom ${theme === 'dark' ? 'dark:bg-gray-800 dark:text-white' : ''}`} data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">
              <h2 className="w3-text-grey w3-padding-16 dark:text-gray-300">
                <PermanentMarkerText>Berufserfahrung</PermanentMarkerText>
              </h2>

              {/* Siemens */}
              <div className="w3-container">
                <h5 className="w3-opacity dark:text-gray-200">
                  <PermanentMarkerText><b>Lagerarbeiter - Falkensee SE, Siemens Energy</b></PermanentMarkerText>
                </h5>
                <h6 className="w3-text-teal dark:text-teal-300"><PermanentMarkerText>bis 04.2025</PermanentMarkerText></h6>
                <ul className="dark:text-gray-300">
                  <li><PermanentMarkerText>Verantwortlich für Lagerorganisation und -management</PermanentMarkerText></li>
                  <li><PermanentMarkerText>Unterstützung bei Qualitätskontrolle und Dokumentation</PermanentMarkerText></li>
                  <li><PermanentMarkerText>Beteiligung an Wareneingang und -ausgang</PermanentMarkerText></li>
                </ul>
              ...
              <div className="w3-container">
                <h5 className="w3-opacity dark:text-gray-200">
                  <PermanentMarkerText><b>Lagerarbeiter - BSH Service Nauen GmbH</b></PermanentMarkerText>
                </h5>
                ...
                <ul className="dark:text-gray-300">
                  ...
                  <li><PermanentMarkerText>Bedienung von Scansystemen für Bestandsführung</PermanentMarkerText></li>
                  <li><PermanentMarkerText>Teamarbeit in respektvollem Arbeitsumfeld</PermanentMarkerText></li>
                </ul>
                <hr className="dark:border-gray-700" />
              </div>
              ...
              <div className="w3-container">
                <h5 className="w3-opacity dark:text-gray-200">
                  <PermanentMarkerText><b>Lagerarbeiter - Pharmaprodukte, Farmacol.SA</b></PermanentMarkerText>
                </h5>
                <h6 className="w3-text-teal dark:text-teal-300"><PermanentMarkerText>2019 – 2021</PermanentMarkerText></h6>
                <ul className="dark:text-gray-300">
                  <li><PermanentMarkerText>Verwaltung und Verteilung von Medizinprodukten</PermanentMarkerText></li>
